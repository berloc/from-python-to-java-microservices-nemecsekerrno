...
public class GoogleMapsAPIService {
    ...
    /**
     * There will only ever be one instance of that
     * particular class because of the singleton design pattern
     * and you get it with the getINSTANCE method.
     * @return
     */
    ...
    /**
     * Create the url with the parameters and the api key.
     * @param origin
     * @param destination
     * @return
     * @throws IOException
    ...
    /**
     * Extract data from the response of the Google service.
     * @param res
     * @param rawData
     * @return
     */
    ...
    /**
     * Responsible for generating specified error messages.
     * @param response
     * @param statusCode
     * @param message
     * @return
